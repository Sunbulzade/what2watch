...
export async function GET(request: NextRequest) {
  try {
    ...
    // Get the user with their watchlist movies
    ...
    // Get the poster data for each watchlist movie
    ...
    // Return the watchlist movies with their posters
    return NextResponse.json({ 
      watchlist: watchlistWithPosters,
      success: true 
    });
  } catch (error) {
